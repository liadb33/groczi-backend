...
import { 
  ...
  fetchDataForMultiStoreFromList,   // <<< --- NEW FOR MULTI-STORE
} from "../repositories/optimization.repository.js";
import { 
  rankEligibleStoresForItemList,
  runTopNMultiStoreDPForList,       // <<< --- NEW FOR MULTI-STORE
} from "../services/optimization.service.js";
import {
  OptimizeSingleStoreListRequestBody,
  RankedStoresOptimizationResult,
  OptimizeMultiStoreListRequestBody,  // <<< --- NEW FOR MULTI-STORE
  TopMultiStoreSolutionsResult,       // <<< --- NEW FOR MULTI-STORE
...
// --- NEW: Controller for Multi-Store DP Optimization (List-Based, Top N) ---
